...
{
    [FormerlySerializedAs("biomeTilemapGenerator")] public TilemapGenerator tilemapGenerator;
    ...
    {
        tilemapGenerator.OnchunkGenerated += GenerateNavMeshGrid;
    }
    ...
    {
        width = tilemapGenerator.chunkWidth;
        height = tilemapGenerator.chunkHeight;
        ...
        for (int x = 0; x < width; x++)
        {
            for (int y = 0; y < height; y++)
            {
                ...
                TileBase tile = tilemapGenerator.GetTileAtPosition(worldPosition);
